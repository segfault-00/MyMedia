...
public class EditProfilePage extends AppCompatActivity {
    ...
    /***
    String storagepath1 = "Users_Profile_Cover_image_back/";
     **/
    String uid;
    ImageView set,setBack;
    TextView profilepic,/*profilepicBack,*/profileCover, editname, editpassword,bio;
    ProgressDialog pd;
    ...
    Uri imageuri;
    String profileOrCoverPhoto /*profileOrCoverPhotoBack*/;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setBack = findViewById(R.id.setting_profile_image_back);    /*****/
        ...
        query.addValueEventListener(new ValueEventListener() {
            // data retrive from firebase to this Activity
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    try {
                        Glide.with(EditProfilePage.this).load(imageBack).into(setBack);
                    } catch (Exception e) {
                    }
                }
            }
        ...
        profileCover.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                pd.setMessage("Updating Profile Cover");
                profileOrCoverPhoto = "imageCover";
                storagepath = "Users_Profile_Cover_image_back/";
                showImagePicDialog();
            }
        });
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    String imageBack = "" + dataSnapshot1.child("imageCover").getValue();  /*****/
                    try {
                        Glide.with(EditProfilePage.this).load(image).placeholder(R.drawable.profile_image).into(set);
                    } catch (Exception e) {
                    }
                    /**
                    try {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    /****/
                    try {
                        Glide.with(EditProfilePage.this).load(imageBack).placeholder(R.drawable.profile_image).into(setBack);
                    } catch (Exception e) {
                    }
