...
import com.example.brijesh.adapter.AdapterComment;
import com.example.brijesh.model.ModelComment;
...
public class PostDetailsActivity extends AppCompatActivity {
    ...
    String hisuid, ptime, myuid, myname, myemail, mydp, uimage, postId,postBy, plike, hisdp, hisname;
