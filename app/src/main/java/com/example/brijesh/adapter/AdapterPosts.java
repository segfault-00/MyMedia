...
public class AdapterPosts extends RecyclerView.Adapter<AdapterPosts.MyHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        final String[] cover = new String[1];
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                   ...
                   bio[0] = "" + dataSnapshot1.child("bio").getValue();
                   cover[0] = "" + dataSnapshot1.child("imageCover").getValue();

                    // setting data to our text vie
                }
            }
        ...
        holder.picture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("udp", dp);
                intent.putExtra("uname",nameh);
                intent.putExtra("ubio", bio[0]);
                intent.putExtra("uemail",email);
                intent.putExtra("ucover", cover[0]);
                holder.itemView.getContext().startActivity(intent);
            }
        });
        //****************************
